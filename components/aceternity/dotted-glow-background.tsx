...
/**
 * Canvas-based dotted background that randomly glows and dims (Aceternity UI pattern).
 * @see https://ui.aceternity.com/components/dotted-glow-background
 */
export function DottedGlowBackground({
  ...
  return (
    <div ref={containerRef} className={cn("relative h-full min-h-full w-full overflow-hidden", className)}>
